...
SCRIPT_VERSION = "2.0-package1-horizontal-dates"
...
def main() -> None:
    ...
    print("Додано аналітичний пакет: ключові індикатори, Україна — експорт, внутрішній ринок, портові спреди, премії пшениці та конкуренти Чорного моря.")
